...
public class alumnoDAO {
    ...
    private static final String SQL_INSERT = "INSERT INTO alumnos(carnet_alumno, nombrealumno, direalumno,  telefono,  emailalumno,  Estatus_alumno) VALUES(?, ?)";
    private static final String SQL_UPDATE = "UPDATE alumnos SET nombrevendedor=?, direvendedor=? WHERE idvendedor = ?";
